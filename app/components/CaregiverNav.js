...
export default function CaregiverNav() {
  ...
  const tabs = [
    { icon: "🏠", label: "Home", route: "/screens/CaregiverDashboard" },
    { icon: "👥", label: "Patients", route: "/screens/PatientsList" },
    { icon: "📋", label: "Tasks", route: "/screens/CaregiverTasks" },
    { icon: "📅", label: "Schedule", route: "/screens/CaregiverSchedule" },
    { icon: "👤", label: "Profile", route: "/screens/CaregiverProfile" },
  ];
  return (
