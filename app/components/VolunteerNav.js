...
export default function VolunteerNav() {
  ...
  const tabs = [
    { icon: "🏠", label: "Home", route: "/screens/VolunteerDashboard" },
    { icon: "🗂️", label: "Tasks", route: "/screens/VolunteerTasks" },
    { icon: "🔍", label: "Explore", route: "/screens/VolunteerExplore" },
    { icon: "🌟", label: "Impact", route: "/screens/VolunteerImpact" },
    { icon: "👤", label: "Profile", route: "/screens/VolunteerProfile" },
  ];
  return (
